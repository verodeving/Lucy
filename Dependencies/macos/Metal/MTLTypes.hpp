...
struct Size
{
    ...
    constexpr Size(NS::UInteger width, NS::UInteger height, NS::UInteger depth);
...
_MTL_INLINE constexpr MTL::Size::Size(NS::UInteger _width, NS::UInteger _height, NS::UInteger _depth)
    : width(_width)
    , height(_height)
    , depth(_depth)
{
