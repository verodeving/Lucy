...
namespace MTK
{
	class ViewDelegate
	{
		public:
			...
			virtual void				drawInMTKView( class View* ) { }
			virtual void				drawableSizeWillChange( class View*, CGSize) { }
	};
...
_NS_INLINE void MTK::View::setDelegate( const MTK::ViewDelegate* pDelegate )
{
	...
	void (*drawDispatch)( NS::Value*, SEL, id ) = []( NS::Value* pSelf, SEL, id pMTKView ){
